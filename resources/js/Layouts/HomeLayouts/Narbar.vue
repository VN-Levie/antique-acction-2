              ...
              <div class="flex flex-col md:flex-row">
                <div class="w-full md:w-1/2 border-r">
                  <div class="pb-3">
                    ...
                    <div>
                      ...
                      <a :href="route('address.index')" class="text-sm hover:text-red-600 hover:underline pl-1 pt-3">
                        {{ $page.props.auth.address.address1 }} {{ $page.props.auth.address.address2 }} <br> {{
                          $page.props.auth.address.city }}</a>
                ...
                <div class="w-full md:w-1/2 md:ml-5">
                  <div class="pb-3">
                    ...
                    <div>
                      <Link :href="route('profile.edit')" class="text-sm hover:text-red-600 hover:underline pt-3">Account
                      </Link>
                    </div>
