    ...
    >
      ...
      <div class="flex items-center justify-between">
        ...
        <div @click="toggleNav" class="flex md:hidden">
          ...
          >
            <svg
              viewBox="0 0 24 24"
              class="w-6 h-6 fill-current bg-black hover:after:bg-yellow-300"
            >
              <path
                fill-rule="evenodd"
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <a
                :href="child.href"
                class="ul-letter-spaceing cool-link block px-4 py-2 text-sm"
              >
                {{ child.name }}
              </a>
            </li>
        ...
        <div
          ...
          class="border-after mt-8 space-x-5 space-y-0md:flex md:space-y-0 md:mt-0 cursor-pointer"
        >
          <div>
            <div class="text-[12px]">
