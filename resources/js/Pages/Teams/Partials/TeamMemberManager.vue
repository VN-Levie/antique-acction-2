...
import DangerButton from '@/Components/Dashboard/DangerButton.vue';
...
import SecondaryButton from '@/Components/Dashboard/SecondaryButton.vue';
                    ...
                    <div class="space-y-6">
                        <div v-for="user in team.users" :key="user.id" class="flex items-center justify-between">
                            ...
                            <div class="flex items-center">
                                ...
                                <!-- Leave Team -->
                                <button
                                    v-if="$page.props.auth.users.id === user.id"
