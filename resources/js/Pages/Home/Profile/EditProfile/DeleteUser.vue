<script setup>
import DangerButton from './profileComponent/DangerButton.vue'
import InputError from './profileComponent/InputError.vue';
import InputLabel from './profileComponent/InputLabel.vue';
import Modal from './profileComponent/Modal.vue';
import SecondaryButton from './profileComponent/SecondaryButton.vue';
            ...
            <div class="col-md-4 rounded-lg border-right">
                <div class="p-3 py-5">
                    ...
                    <div>
                        ...
                        <DangerButton class="row mt-10" @click="confirmUserDeletion">Delete Account</DangerButton>
